...
app.get("/privacy-policy", (req, res) => {
  res.send(`
    ...
    <p>
      This application uses Instagram Graph API
      to automate replies to comments and messages.
    </p>
    <p>
...
app.get("/terms", (req, res) => {
  res.send(`
    ...
    <p>
      By using this automation service,
...
`;
        ...
        reply =
          "🎉 Today's Offer: Buy 2 Teas Get 1 Free!";
      }
